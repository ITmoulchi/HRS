export const site = {
  ...
  city: "Casablanca",
  phone: "05 22 45 07 42",
  phoneHref: "tel:+212522450742",
  hours: {
    weekdays: "Lun – Ven · 9h00 – 18h00",
    saturday: "Sam · 9h00 – 13h00",
  },
  address:
    "Angle bd La Résistance et bd Mohammed VI, résidence Albayda 1, 2ème étage, N°212, Casablanca",
  mapsUrl: "https://maps.app.goo.gl/88MmxTutXhZopqxx7",
  instagramUrl: "https://www.instagram.com/hrshanane/",
  instagramHandle: "@hrshanane",
  formations: [
    {
      title: "Thérapie Manuelle",
      school: "EBP Health Training & AMTM",
    },
    {
  ...
  servicesSection: {
    eyebrow: "Services",
    title: "Des soins complets pour chaque besoin",
    intro:
      "Du sportif au patient en rééducation, chaque prise en charge est adaptée à vos objectifs et à votre rythme de récupération.",
  },
  services: [
    {
  ...
  contact: {
    ...
    intro:
      "Le cabinet est situé à Casablanca. Prenez rendez-vous par téléphone ou trouvez-nous facilement via Google Maps.",
  },
} as const;
